...
//		}
		...
		val destinationDetail: DestinationService = ServiceBuilder.buildService(DestinationService::class.java)

		val requestCall: Call<Destination> = destinationDetail.getDestination(id)

		requestCall.enqueue(object : Callback<Destination>{
			override fun onFailure(call: Call<Destination>, t: Throwable) {
				Toast.makeText(this@DestinationDetailActivity,"Error"+t.toString(),Toast.LENGTH_LONG).show()
			}
			...
			override fun onResponse(call: Call<Destination>, response: Response<Destination>) {
				if(response.isSuccessful){
					...
					Toast.makeText(this@DestinationDetailActivity,"Failed to retrieve",Toast.LENGTH_LONG).show()
				}
			}
